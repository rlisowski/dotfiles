...
Plug 'https://github.com/rbong/vim-flog.git'                            " A lightweight and powerful git branch viewer for vim.
...
" GRAVEYARD
" ---------------
" Plug 'https://github.com/katono/rogue.vim.git'               " Roogue like vim game
